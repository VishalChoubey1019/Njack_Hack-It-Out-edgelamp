    ...
    return (
        <div className="fixed z-50 top-0 left-0 h-[100vh] flex flex-col items-center justify-center">
            <div className="mx-10 w-16 min-h-[80vh] border flex flex-col items-center justify-center shadow-lg rounded-lg py-2 px-4 text-[1.5rem] gap-8 bg-white">
                ...
                <Tooltip title="Add" placement="top">
                    <BiImageAdd className='text-[1.8rem] cursor-pointer' onClick={() => contextValues.addImage(contextValues.canvas)} />
                </Tooltip>
                <Tooltip title="Add" placement="top">
                    <AiOutlineHighlight className='text-[1.8rem] cursor-pointer' onClick={() => contextValues.addImage(contextValues.canvas)} />
                </Tooltip>
            </div>
        </div>
    )
